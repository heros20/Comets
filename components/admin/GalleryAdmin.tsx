...
export default function GalleryAdmin() {
  ...
  async function handleAdd(e: React.FormEvent) {
    ...
    if (res.ok) {
      // Passe un seul argument en concaténant
      await logAdminAction(`Ajouté une image à la galerie - admin: ${adminUser}`);
  ...
  async function handleDelete(id: number) {
    ...
    if (res.ok) {
      await logAdminAction(`Supprimé une image de la galerie - admin: ${adminUser}`);
