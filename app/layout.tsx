  ...
  return (
    <html lang="fr">
      <head>
        ...
        <meta property="og:description" content="Rejoignez Les Comets d'Honfleur, l'équipe de baseball de la région. Suivez nos actualités, matchs et entraînements." />
        ...
        <meta name="twitter:description" content="Rejoignez Les Comets d'Honfleur, l'équipe de baseball de la région. Suivez nos actualités, matchs et entraînements." />
